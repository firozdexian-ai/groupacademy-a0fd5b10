...
export function VCFirmsManager() {
 ...
 <DialogContent className="max-w-2xl rounded-2xl border-4 border-border/40 p-0 overflow-hidden bg-background/95 shadow-sm">
 ...
 <DialogContent className="max-w-md rounded-2xl border border-destructive/30 bg-background/95 p-0 overflow-hidden shadow-sm">
