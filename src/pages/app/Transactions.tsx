  ...
  return (
    <div className={PAGE_SHELL_WIDE}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3 p-1.5 h-16 bg-muted/30 rounded-[32px] border border-border/40">
          <TabsTrigger
            value="history"
            className="rounded-[24px] font-black text-[10px] uppercase tracking-widest data-[state=active]:bg-background"
          >
            History
          </TabsTrigger>
          <TabsTrigger
