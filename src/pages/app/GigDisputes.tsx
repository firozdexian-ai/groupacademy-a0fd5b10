...
export default function GigDisputes() {
 ...
 className="rounded-lg border border-border/60 bg-card shadow-none overflow-hidden block w-full"
 >
 ...
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 font-mono text-sm font-medium text-muted-foreground/50 uppercase tracking-tight select-none pointer-events-none leading-none tabular-nums w-full shrink-0">
