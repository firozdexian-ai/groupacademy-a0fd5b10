...
import { ServiceHistoryCard } from "@/domains/finance/components/talent/ServiceHistoryCard";
...
export default function ServicesHub() {
 ...
 <h2 className="text-sm font-medium tracking-[0.3em] text-primary flex items-center gap-3">
 ...
 <div
 className={cn(
 "h-16 w-16 rounded-xl flex items-center justify-center mb-8 shadow-inner",
 service.iconBg,
 )}
 >
 ...
 <h2 className="text-sm font-medium tracking-[0.3em] text-primary">Service Tracking List</h2>
 </div>
