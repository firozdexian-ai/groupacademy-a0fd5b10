...
export default function JobAssessment() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 pb-32 space-y-5 w-full">
            ...
            <div className="border border-dashed border-border/60 rounded-lg p-6 text-center space-y-4">
              {recording ? (
                ...
                <div className="space-y-2 py-2">
                  ...
                  <p className="text-xs text-muted-foreground">Saving your audio response...</p>
                </div>
              ) : hasAnswered ? (
                <>
      ...
      <div className="fixed bottom-0 inset-x-0 p-4 bg-background/95 backdrop-blur border-t border-t-border/40 z-30">
        <div className="max-w-2xl mx-auto flex gap-2">
          <Button
            variant="outline"
            onClick={() => setCurrentIndex((p) => p - 1)}
            disabled={currentIndex === 0 || recording || uploading || submitting}
          ...
          <Button
            ...
            disabled={submitting || uploading || recording || !hasAnswered}
          ...
          >
            ...
            {!isLastQuestion && !submitting && <ArrowRight className="ml-2 h-4 w-4" />}
          </Button>
        </div>
      </div>
    </div>
