        ...
        <Sheet open={filtersOpen} onOpenChange={setFiltersOpen}>
          <SheetTrigger asChild>
            ...
            >
              ...
              <span>Filters</span>
              {activeFilterCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 h-4 min-w-[18px] px-1 rounded bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center border border-background tabular-nums">
                  {activeFilterCount}
                </span>
              )}
            </Button>
          ...
          <SheetContent side="right" className="w-full sm:w-[380px] overflow-hidden border-l border-border/60 bg-popover/95 backdrop-blur-md">
            ...
            <ScrollArea className="h-[calc(100vh-160px)] pr-2 mt-4 w-full">
              <div className="space-y-6 w-full pb-16">
                ...
                <div className="space-y-2.5 w-full">
                  <Label className="text-[10px] font-bold uppercase text-muted-foreground/60 tracking-wide pb-1 border-b border-border/5 mb-1.5 block">
                    Job type
                  </Label>
                ...
                <div className="space-y-3 w-full">
                  <div className="flex justify-between items-center w-full">
                    <Label className="text-[10px] font-bold uppercase text-muted-foreground/60 tracking-wide">
                      Minimum salary
                    </Label>
                    <span className="text-[10px] font-bold uppercase text-primary bg-primary/5 px-2 py-0.5 rounded border border-primary/10 tabular-nums">
            ...
            <SheetFooter className="absolute bottom-0 left-0 right-0 p-4 bg-background/95 backdrop-blur-md border-t border-border/20 flex flex-row gap-3 w-full">
              <Button
                type="button"
                variant="ghost"
