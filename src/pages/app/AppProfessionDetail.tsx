...
export default function AppProfessionDetail() {
 ...
 className="flex-1 h-8 rounded-lg text-xs font-medium tracking-wider gap-1 cursor-pointer"
 >
 ...
 className="flex-1 h-8 rounded-lg text-xs font-medium tracking-wider cursor-pointer border border-border/60 bg-background/50"
 >
 Catalog Index
 </Button>
 </div>
 ...
 <div className="flex items-center gap-3 font-mono text-[9px] sm:text-sm font-medium text-muted-foreground/40 uppercase tracking-tight leading-none select-none pointer-events-none tabular-nums block truncate">
