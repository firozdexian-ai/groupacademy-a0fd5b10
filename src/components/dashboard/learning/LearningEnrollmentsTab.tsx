...
import { Plus, Pencil, Trash2, Users, ShieldCheck, User, BookOpen } from "lucide-react";
...
export function LearningEnrollmentsTab() {
  const {
    learningGraphQuery,
    mutations: { upsertEnrollment, deleteEnrollment },
  } = useLearningGraph();
                      ...
                      <TableCell className="text-right pr-8">
                        <div className="flex justify-end gap-2 opacity-20 group-hover:opacity-100 transition-opacity">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (confirm("Purge Enrollment?")) deleteEnrollment.mutate(row.id);
                            }}
                          >
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={draft.status} onValueChange={(v) => setDraft({ ...draft, status: v })}>
                ...
                <SelectContent>
                  <SelectItem value="active" className="font-bold text-xs uppercase tracking-widest text-blue-500">
                    Active
                  </SelectItem>
                  <SelectItem
                    value="completed"
                  ...
                  <SelectItem value="dropped" className="font-bold text-xs uppercase tracking-widest text-rose-500">
                    Dropped
                  </SelectItem>
                </SelectContent>
              </Select>
