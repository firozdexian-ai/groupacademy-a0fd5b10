    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Card className="rounded-[40px] border-2 border-border/40 bg-card/30 backdrop-blur-xl shadow-2xl overflow-hidden">
        ...
        <Tabs value={tab} onValueChange={setTab} className="p-6">
          <TabsList className="rounded-2xl border-2 bg-muted/30">
            <TabsTrigger value="single" className="rounded-xl gap-2">
              <FilePlus2 className="h-4 w-4" /> Single Upload
            </TabsTrigger>
            <TabsTrigger value="batch" className="rounded-xl gap-2">
              <FileUp className="h-4 w-4" /> Batch Upload
            </TabsTrigger>
            <TabsTrigger value="gig" className="rounded-xl gap-2">
