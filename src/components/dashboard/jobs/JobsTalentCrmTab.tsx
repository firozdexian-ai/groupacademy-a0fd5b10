...
import { Plus, Pencil, Trash2, UserCheck, ShieldCheck, Building2 } from "lucide-react";
...
export function JobsTalentCrmTab() {
  const {
    jobsGraphQuery,
    mutations: { upsertCrmRecord, deleteCrmRecord },
  } = useJobsGraph();
                      ...
                      <TableCell className="text-right pr-8">
                        <div className="flex justify-end gap-2 opacity-20 group-hover:opacity-100 transition-opacity">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (confirm("Purge Record?")) deleteCrmRecord.mutate(row.id);
                            }}
                          >
