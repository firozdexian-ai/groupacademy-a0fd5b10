...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    className={cn(
      buttonVariants(),
      "h-9 px-5 rounded-xl font-bold text-xs uppercase tracking-wider shadow-md transform-gpu active:scale-[0.995] transition-transform flex items-center justify-center cursor-pointer bg-primary text-primary-foreground hover:bg-primary/90 min-w-[100px] w-full sm:w-auto",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "h-9 px-4 rounded-xl text-muted-foreground hover:text-foreground font-bold uppercase text-[10px] tracking-wide shrink-0 transition-colors cursor-pointer w-full sm:w-auto mt-0",
      className,
    )}
    {...props}
  />
